...
class Decoder(nn.Module):
    ...
    def forward(self, z, bin_feats):
        ...
        #print("🧪 [Decoder] bin_feats:", bin_feats)
        #print("🧪 [Decoder] max(bin_feats):", max(bin_feats), " / x.shape[1] =", x.shape[1])
        assert max(bin_feats) < x.shape[1], "❌ bin_feats index out of bounds!"
